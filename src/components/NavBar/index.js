    ...
    return(
        <div> 
            ...
            >
                ...
                <Menu.Item as={Link} to={ROUTES.ADD_LINK}><Icon name='Plus' />Add Items via Link</Menu.Item>
        ...
        return(
            <div>
                <Menu fixed="top" inverted style = {{width: '100%'}}>
                    ...
                    <Menu.Item name = "add-link" onClick = {this.handleItemClick} active={activeItem === 'add-link'} as={Link} to={ROUTES.ADD_LINK}><Icon name='plus' />Add Items via Link</Menu.Item>
